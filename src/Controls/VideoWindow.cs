...
namespace Zhai.VideoView
{
    public class VideoWindow : Window
    {
        ...
        public static readonly DependencyProperty TitleBarProperty = DependencyProperty.Register(nameof(TitleBar), typeof(FrameworkElement), typeof(VideoWindow), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty TitleBarVisibilityProperty = DependencyProperty.Register(nameof(TitleBarVisibility), typeof(Visibility), typeof(VideoWindow), new FrameworkPropertyMetadata(Visibility.Visible, FrameworkPropertyMetadataOptions.Inherits));



        public VideoWindow()
        {
            this.SourceInitialized += VideoWindow_SourceInitialized;
            this.Loaded += VideoWindow_Loaded;
        }

        private void VideoWindow_SourceInitialized(object sender, EventArgs e)
        {
        ...
        {
            var template = App.Current.Resources["VideoWindowTemplete"] as ControlTemplate;
