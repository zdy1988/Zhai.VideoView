...
namespace Zhai.VideoView.Commands
{
    /// <summary>
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        {
            return CanExecuteCommand == null || CanExecuteCommand(parameter == null ? default : (T)parameter);
        }
        ...
        {
            ExecuteCommand?.Invoke(parameter == null ? default : (T)parameter);
        }
